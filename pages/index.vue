<template>
  <div class="flex flex-col gap-3 w-full h-screen m-auto justify-center items-center">
    <nuxt-img class="mb-2 ganyu-img" src="/ganyu.png" width="128" height="128" alt="Ganyu" />
